...
async function POST(req) {
    try {
        ...
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])({
            id: user.id,
            email: user.email,
            name: user.name,
            role: user.role
        ...
        res.cookies.set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_COOKIE_NAME"], token, {
            httpOnly: true,
            secure: ("TURBOPACK compile-time value", "development") === "production",
            sameSite: "lax",
            maxAge: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_MAX_AGE"],
            path: "/"
        });
        return res;
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0w097cg._.js.map